...
export const THEMES = {
  'rose-noir': {
    ...
    vars: {
      ...
      '--text-faint': 'rgba(245,236,240,0.60)',
      '--text-primary': '#f5ecf0',
      '--accent': '#ff4d79',
      '--accent-2': '#ff8aad',
      '--accent-alt': '#ff8aad',
  ...
  ember: {
    ...
    vars: {
      ...
      '--text-faint': 'rgba(247,237,224,0.60)',
      '--text-primary': '#f7ede0',
      '--accent': '#ff9a3d',
      '--accent-2': '#ffc36b',
      '--accent-alt': '#ffc36b',
  ...
  emerald: {
    ...
    vars: {
      ...
      '--text-faint': 'rgba(224,245,238,0.60)',
      '--text-primary': '#e0f5ee',
      '--accent': '#22c997',
      '--accent-2': '#5fe3bd',
      '--accent-alt': '#5fe3bd',
  ...
  'cyan-ice': {
    ...
    vars: {
      ...
      '--text-faint': 'rgba(224,244,250,0.60)',
      '--text-primary': '#e0f4fa',
      '--accent': '#2bc4e0',
      '--accent-2': '#6fe4f5',
      '--accent-alt': '#6fe4f5',
  ...
  indigo: {
    ...
    vars: {
      ...
      '--text-faint': 'rgba(230,235,255,0.60)',
      '--text-primary': '#e6ebff',
      '--accent': '#6d8bff',
      '--accent-2': '#a9bcff',
      '--accent-alt': '#a9bcff',
  ...
  sunset: {
    ...
    vars: {
      ...
      '--text-faint': 'rgba(255,232,236,0.60)',
      '--text-primary': '#ffe8ec',
      '--accent': '#ff6a6a',
      '--accent-2': '#ffb38a',
      '--accent-alt': '#ffb38a',
  ...
  carbon: {
    ...
    vars: {
      ...
      '--text-faint': 'rgba(237,237,238,0.60)',
      '--text-primary': '#ededee',
      '--accent': '#d4d6da',
      '--accent-2': '#eceef0',
      '--accent-alt': '#eceef0',
